...
gsefile = "/home/hypodd/Datasets/WEEK_1/Vel_out/hyp-deren.out"
...
wfdir = "/home/hypodd/Datasets/WEEK_1/5_SAC_NA/Sac_DEREN/"
relocator.add_waveform_files(glob.glob(wfdir+"/*/*/*"))
relocator._parse_waveform_files()
output_cross_correlation_file='Deren_relocator_working_dir/out_cc.txt'
