...
gsefile = "/home/hypodd/Datasets/WEEK_1/Vel_out/hyp-tavan.out"

relocator = HypoDDRelocator(working_dir="Tavan_relocator_working_dir",
    cc_time_before=0.20,
    cc_time_after=0.8,
    cc_maxlag=0.3,
...
relocator.add_station_files(glob.glob('/home/hypodd/Datasets/WEEK_1/3_RESPONSE/DATALESS/XL_dataless_noHD20AHD47A'))
relocator.add_station_files(glob.glob(dldir+'/Regional/*.seed'))
relocator.add_station_files(glob.glob(dldir+'/UB_network/*.seed'))
relocator.add_station_files(glob.glob(dldir+'/Mongolia_experiment/*.seed'))
...
wfdir = "/home/hypodd/Datasets/WEEK_1/5_SAC_NA/Sac_TAVAN/"
relocator.add_waveform_files(glob.glob(wfdir+"/*/*/*"))
relocator._parse_waveform_files()
output_cross_correlation_file='Tavan_relocator_working_dir/out_cc.txt'
